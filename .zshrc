...
# Show all, by time (newest), reverse, long list format.
# So, show a list of all files where the newest in the bottom.
alias ll="ls -latr"

# Set up kubectl autocomplete in zsh into the current shell
...
# Fix fzf `option + c` - https://github.com/junegunn/fzf/issues/164#issuecomment-581837757
bindkey "ç" fzf-cd-widget

# Setup fzf previews
export FZF_CTRL_T_OPTS="--preview 'bat --theme=TwoDark --style=numbers --color=always -n --line-range :500 {}'"
...
# fzf git branch with diffs previews
