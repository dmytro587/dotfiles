...
description: Use when a user provides a YouTube URL and needs spoken captions for analysis, summarization, quoting, or search.
---
# YouTube Transcript
...
Use this reference script when a YouTube transcript is needed:

```bash
python3 ~/.agents/skills/youtube-transcript/fetch_transcript.py "<youtube_url>"
```
